            ...
            <div class="row basicdetail">
                {!! Form::open(['route' => ['services.store'], 'method' => 'POST', 'files' => 'true']) !!}
                    <div class=" col-lg-offset-1 col-lg-10 mt10">
                        ...
                        <div class="text-center col-lg-12 mb10">
...
$(document).ready(function() {
    ...
    $(add_button1).click(function(e){
        ...
        if(x1 < max_fields1){
            x1++;
            $(wrapper1).append('<div style="margin-top:20px"><input type="text" name="benifit[]" class="form-control" placeholder="Type your feature"><a href="#" style="position: relative; top: -24px; left: 320px;" class="remove_field"><i class="fa fa-close"></i></a></div>');
        }
    });
    ...
    $(add_button2).click(function(e){
        ...
        if(x2 < max_fields2){
            x2++;
            $(wrapper2).append('<div style="margin-top:20px"><input type="text" name="include[]" class="form-control" placeholder="Type your package"><a style="position: relative; top: -24px; left: 320px;" href="#" class="remove_field"><i class="fa fa-close"></i></a></div>');
        }
    });
