...
@section('title') | Availability | Personal-meeting @endsection
@section('content')
...
<!-- <div class="container">
    <div class="row"> -->
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Personal Meeting</li>
      </ol>
    </section>
    <hr>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                  Add Personal Meeting Availabilities
                </div>

                <div class="panel-body">
                  {!! Form::open(['route' => ['availabilities.store'], 'method' => 'POST']) !!}
                  {{ Form::hidden('consultation_mode', 'personal_meeting') }}
...
$(document).ready(function() {
  ...
  var temp='<div class="col-md-3"><div class="form-group"><label>SELECT DAYS</label><select class="form-control" name="day[]"><option value="monday">Monday</option><option value="tuesday">Tuesday</option><option value="Wednesday">wednesday</option><option value="thursday">Thursday</option><option value="friday">Friday</option> <option value="saturday">Saturday</option><option value="sunday">Sunday</option></select></div></div><div class="col-md-3"><div class="bootstrap-timepicker"><div class="form-group"><label>FROM</label><div class="input-group"><input type="time" name="time_from[]" style="width: 100%" class="form-control"></div></div></div></div><div class="col-md-3"><div class="bootstrap-timepicker"><div class="form-group"><label>TO</label><div class="input-group"><input type="time" name="time_to[]" style="width: 100%" class="form-control"></div></div></div></div><div class="col-md-3"><div class="form-group"><label>Location</label><select name="location[]" class="form-control">@foreach(Auth::user()->locations as $location)<option value="{{ $location->id }}">{{ $location->address }}</option>@endforeach</select></div></div>'
