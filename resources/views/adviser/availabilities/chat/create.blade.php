    ...
    <section class="content">
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <label>  Add Chat Availabilities</label>
                </div>

                <div class="panel-body">
                  {!! Form::open(['route' => ['availabilities.store'], 'method' => 'POST']) !!}
                  {{ Form::hidden('consultation_mode', 'chat') }}
                       <div class="form-group">
                                <label >Number of Questions to be Asked :</label>
                                 <label class="ml20"><input type="radio" class="flat" name="consultation_question" value="10" checked="" required /> 10</label>
                                 <label class="ml20"><input type="radio" class="flat" name="consultation_question" value="20" checked="" required /> 20</label>
                                <label class="ml20"><input type="radio" class="flat" name="consultation_question" value="30" checked="" required /> 30</label>
                                <label class="ml20"><input type="radio" class="flat" name="consultation_question" value="10" checked="" required /> 40</label>
                           </div>
                           <div class="col-md-4">
                              <div class="form-group">
