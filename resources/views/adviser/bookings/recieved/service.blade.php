...
@section('title') | Appointments Recieved | Services @endsection
@section('content')
                    ...
                    <div class="panel-body">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="modal-body">
                         {!! Form::open(['route' => ['bookings.recieved.service.cancel', $service->id], 'method' => 'POST', 'id' => 'cs1'.$service->id]) !!}
                      ...
                      <div class="col-md-12">
                        {!! Form::open(['route' => ['bookings.recieved.service.confirm', $service->id], 'method' => 'POST', 'id' => 'cmdt'.$service->id]) !!}
                        <table class="table">
                          <tbody>
                  ...
                  <div class="panel-heading">
                    ...
                    <div class="panel-body">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="modal-body">
                        {!! Form::open(['route' => ['bookings.recieved.reschedule', $service->id], 'method' => 'POST', 'id' => 'rs1'.$service->id, 'class' => 'form-inline']) !!}
                         <div class="form-group">
                        ...
                        {!! Form::open(['route' => ['bookings.recieved.service.document', $service->id], 'method' => 'POST', 'files' => true, 'id' =>'cbd'.$service->id]) !!}
                        ...
                        <div class="modal-body">
                         {!! Form::open(['route' => ['bookings.recieved.service.cancel', $service->id], 'method' => 'POST', 'id' => 'cs2'.$service->id]) !!}
                         <div class="form-group">
                           {{ Form::label('reason', 'Reason to cancel service') }}
                           <select name="reason" class="form-control">
                             <option>Not available on scheduled time.</option>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="modal-body">
                         {!! Form::open(['route' => ['bookings.recieved.service.dispute', $service->id], 'method' => 'POST', 'id' => 'rd1'.$service->id]) !!}
                         <div class="form-group">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="modal-body">
                         {!! Form::open(['route' => ['bookings.recieved.service.dispute', $service->id], 'method' => 'POST', 'id' => 'rd2'.$service->id]) !!}
                         <div class="form-group">
                           {{ Form::label('reason', 'Reason for raising Dsipute') }}
                           <select name="reason" class="form-control">
                             <option>Service not provided/delivered as committed</option>
