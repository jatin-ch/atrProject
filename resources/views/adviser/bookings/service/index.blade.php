                      ...
                      <div class="panel-body">
                        ...
                        <div class="col-md-3">
                          ...
                          @if($service->user->ExpertDetail->type == 'professional')
                           {!! Form::open(['route' => ['adviser.bookings.service.confirm', $service->id], 'method' => 'POST', 'id' => 'cm'.$service->id]) !!}
                          ...
                          <div class="modal-body">
                           {!! Form::open(['route' => ['adviser.bookings.service.cancel', $service->id], 'method' => 'POST', 'id' => 'cs1'.$service->id]) !!}
                        ...
                        <div class="col-md-12">
                          {!! Form::open(['route' => ['adviser.bookings.service.confirm', $service->id], 'method' => 'POST', 'id' => 'cmdt'.$service->id]) !!}
                          <table class="table">
                            <tbody>
                        ...
                        <p><button class="btn btn-default btn-sm btn-block" data-target="#scc1{{$service->id}}" data-toggle="modal">Suggest New Date & Time</button></p>
                          ...
                          <div class="modal-body">
                           <table class="table">
                            <form action="{{ route('adviser.bookings.service.confirm', $service->id) }}" method="POST", id="sdt{{$service->id}}">
                            {{ csrf_field() }}
                            <tbody>
                             <tr>
                    ...
                    <div class="panel panel-default">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="modal-body">
                          {!! Form::open(['route' => ['adviser.bookings.reschedule', $service->id], 'method' => 'POST', 'id' => 'rs1'.$service->id, 'class' => 'form-inline']) !!}
                           <div class="form-group">
                          ...
                          {!! Form::open(['route' => ['adviser.bookings.service.document', $service->id], 'method' => 'POST', 'files' => true]) !!}
                          ...
                          <div class="modal-body">
                           {!! Form::open(['route' => ['adviser.bookings.service.cancel', $service->id], 'method' => 'POST', 'id' => 'cs2'.$service->id]) !!}
                           <div class="form-group">
                             {{ Form::label('reason', 'Reason for cancel Service') }}
                             <select name="reason" class="form-control">
                               <option>Not available on scheduled time.</option>
