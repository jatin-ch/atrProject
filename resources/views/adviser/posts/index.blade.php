                        ...
                        <div class="box-body">
                            <div class="box box-default">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-lg-3">
                                      <a href="{{route('adviser.posts.show',$post->id)}}" id="myBtn" class="btn btn-default btnblog" >View</a>
                                       <a href="{{route('adviser.posts.edit',$post->id)}}" class="btn btn-default btnblog">Edit</a>

                                        {{ Form::open(['route' => ['adviser.posts.destroy', $post->id], 'method' => 'DELETE', 'id' => $post->id]) }}
                                        {{ Form::close() }}
                                        <a onclick="
