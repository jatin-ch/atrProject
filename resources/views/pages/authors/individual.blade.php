                                                 ...
                                                 <div class="col-lg-12">
                                                     <div class="col-lg-4">
                                                        ...
                                                        <div class="card-body " style="padding: 7px;">
                                                            {{ Form::date('date[]', null, ['class' => 'form-control', 'id'=>'fsd', 'required'=>'', 'min'=>Carbon\Carbon::today()->format('Y-m-d')]) }}
                                                        </div>
                                                     </div>
                                                     </div>
                                                 ...
                                                 <div class="col-lg-12">
                                                     ...
                                                     <div class="card" style="border:1px solid gray">
                                                        ...
                                                        <div class="card-body" style="height: 42px;">
                                                            {{ Form::date('date[]', null, ['class' => 'form-control','style' => 'margin-top: 8px;', 'required'=>'', 'min'=>Carbon\Carbon::today()->format('Y-m-d')]) }}
                                                        </div>
                                                     </div>
                                                     </div>
                                                     <div class="col-lg-8">
                                                     ...
                                                     <div class="col-lg-4">
                                                      ...
                                                      <div class="col-lg-8">
                                                        <div class="card" style="border:1px solid gray;margin-top:10px;">
                                                            <div class="card-header dateHeader"><b>Time</b></div>
                                                            <div class="card-body row">
                                                               {{ Form::time('time[]', null, ['class' => 'form-control', 'required'=>'', 'min'=>Carbon\Carbon::today()->format('Y-m-d')]) }}
                                                            </div>
                                                        </div>
                                                     </div>
                                                 ...
                                                 <div class="col-lg-12">
                                                     ...
                                                     <div class="card" style="border:1px solid gray">
                                                        ...
                                                        <div class="card-body" style="padding: 5px;">
                                                            {{ Form::date('date[]', null, ['class' => 'form-control', 'required'=>'', 'min'=>Carbon\Carbon::today()->format('Y-m-d')]) }}
                                                        </div>
                                                     </div>
                                                     </div>
                                                     <div class="col-lg-8">
