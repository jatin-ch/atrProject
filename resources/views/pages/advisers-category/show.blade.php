                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="text-center">
                          <button type="button" class="btn mt60 btn-success"> <b>CHAT </b><br />(200 for 10 questions)</button>
                        </div>
                    ...
                    <div class="col-md-1">
                        <div class="icons">
                            <div class="pull-left">
                               <a href="\"><img src="{{ asset('website/images/like.png') }}" /></a>
                            </div>
                            <div class="pull-right">
                                <a href="\"><img class="img-responsive" src="{{ asset('website/images/share.png') }}" /></a>
                            </div>
                        </div>
             ...
             <div class="col-md-12">
                                  ...
                                  <div class="card mt10">
                                     ...
                                     <ul class="nav nav-tabs text-center" role="tablist">
                                        ...
                                        <li class="menu" style="margin-right:0px " role="presentation"><a href="#personal" aria-controls="Personal" role="tab" data-toggle="tab">Personal Meeting</a></li>
                                    </ul>
                                     ...
                                     <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="phone">
                                            <div class="row">
                                             <div class="text-center font20">
                                                 <strong>Consultation Fees: Rs {{$pc->consultation_payout}}/ Per slot</strong>
                                             </div>
                                             
                                            {!! Form::open(['route' => ['booking.consultation'], 'method' => 'POST', 'id' => $pc->id]) !!}

                                            {{ Form::hidden('availability_id', $pc->id, ['id'=>'fsId']) }}
                                                 ...
                                                 <div class="col-lg-12">
                                                     ...
                                                     <div class="card" style="border:1px solid gray;margin-top:10px;">
                                                        ...
                                                        <div class="card-body " style="padding: 7px;">
                                                            {{ Form::date('date', null, ['class' => 'form-control', 'id'=>'fsd', 'required'=>'']) }}
                                                            </div> 
                                                     </div>
                                                     </div>
                                                     <div class="col-lg-8">
                                                        <div class="card" style="border:1px solid gray;margin-top:10px;">
                                                            ...
                                                            <div class="card-body row">
                                                                ...
                                                                @foreach($pc->firstShifts as $firstshift)
                                                                <div class="col-lg-4">
                                                                <div class="timeSlot ">
                                                           <label style="padding:4px;"><input type="radio" name="time" value="{{ $firstshift->time_from }}">
                                                            {{ date('g:i A' ,strtotime($firstshift->time_from)) }} - {{ date('g:i A' ,strtotime($firstshift->time_to)) }}
                                                          </label>
                                                          </div>
                                                           </div>
                                                            @endforeach
                                                             <!--<select name="time" class="form-control selectFrom" id="fst">-->
                                                                 <!--<option value=""></option>-->
                                                             <!--   @foreach($pc->firstShifts as $firstshift)-->
                                                             <!--   <option value="{{ $firstshift->time_from }}">-->
                                                             <!--       {{ date('g:i A' ,strtotime($firstshift->time_from)) }} - {{ date('g:i A' ,strtotime($firstshift->time_to)) }}-->
                                                             <!--       </option>-->
                                                             <!--   @endforeach-->
                                                             <!-- </select> -->
                                            ...
                                            @else
                                            <div class="text-center font20 pad10 mt10" style="background: #4483f7;color: white;">
                                                    <strong >CHOOSE ANY 3 PREFER DATE ACCORDING TO YOUR CONVENIENCE FOR THE APPOINTMENT</strong>
                                             </div>
                                             <div class="container" style="margin-top: 20px;">
                                                 <div class="preferBdr">
                                                     <h4 style="text-align:center"><b>Preference 1</b></h4>
                                                 <div class="col-lg-12">
                                                     <div class="col-lg-4">
                                                         <div class="card" style="border:1px solid gray;margin-top:10px;">
                                                        <div class="card-header dateHeader"><b>Date</b></div>
                                             ...
                                             {{ Form::hidden('total_pay', $pc->consultation_payout) }}
                                        ...
                                        <div role="tabpanel" class="tab-pane " id="video">
                                            <div class="row">
                                             <div class="text-center font20">
                                                 <strong>Consultation Fees: Rs {{$vc->consultation_payout}}/ Per slot</strong>
                                             </div>
                                             
                                             {!! Form::open(['route' => ['booking.consultation'], 'method' => 'POST', 'id' => $vc->id]) !!}

                                            {{ Form::hidden('availability_id', $vc->id) }}
                                            {{ Form::hidden('user_id', $author->id) }}
                                            ...
                                            <div class="container" style="margin-top: 20px;">
                                                 ...
                                                 <div class="col-lg-12">
                                                     ...
                                                     <!--<div class="card" style="border:1px solid gray;margin-top:10px;">-->
                                                     <!--   <div class="card-header dateHeader"><b>Date</b></div>-->
                                                     <!--   <div class="card-body" style="padding: 7px;">{{ Form::date('date', null, ['class' => 'form-control','required' => '']) }}</div> -->
                                                     <!--</div>-->
                                                     <!--</div>-->
                                                     <!--<div class="col-lg-8">-->
                                                     <!--   <div class="card" style="border:1px solid gray;margin-top:10px;">-->
                                            ...
                                            <div class="text-center font20 pad10 mt10" style="background: #4483f7;color: white;">
                                                 ...
                                                 <div class="col-lg-12">
                                                     ...
                                                     <div class="card" style="border:1px solid gray">
                                                        ...
                                                        <div class="card-body" style="height: 42px;">
                                                            {{ Form::date('date[]', null, ['class' => 'form-control','style' => 'margin-top: 8px;', 'required' => '']) }}
                                                        </div> 
                                                     </div>
                                                     </div>
                                                     <div class="col-lg-8">
                                             ...
                                             {{ Form::hidden('total_pay', $vc->consultation_payout) }}
                                        ...
                                        <div role="tabpanel" class="tab-pane " id="personal">
                                            <div class="row">
                                             <div class="text-center font20">
                                                 <strong>Consultation Fees: Rs {{$pm->consultation_payout}}/ Per slot</strong>
                                             </div>
                                             
                                             {!! Form::open(['route' => ['booking.consultation'], 'method' => 'POST', 'id' => $pm->id]) !!}

                                            {{ Form::hidden('availability_id', $pm->id) }}
                                            {{ Form::hidden('user_id', $author->id) }}
                                            ...
                                            @if($author->expertDetail->type == 'professional')
                                             ...
                                             <div class="container" style="margin-top: 20px;">
                                                 <div class="row preferBdr" style="padding:6px;margin-top:10px ">
                                                     <b>18/47 Vishal Complex,First Floor Shastri Nagar, Delhi - 110097</b><input type="radio" style="float:right " name="optradio">
                                                 </div>
                                                 <div class="row preferBdr" style="padding:6px;margin-top:10px  ">
                                                     <b>D-32 100 Feet Road, Chhatarpur, Delhi - 110096</b><input type="radio" style="float:right " name="optradio">
                                                 </div>
                                             </div>
                                            <div class="container" style="margin-top: 20px;">
                                                 <div class="row">
                                                      @foreach($pm->firstShifts as $firstshift)
                                                     <div class="timeSlot col-md-2">
                                                         <label style="padding:4px;"><input type="radio" name="optradio">
                                                            {{ date('g:i A' ,strtotime($firstshift->time_from)) }} - {{ date('g:i A' ,strtotime($firstshift->time_to)) }}
                                                        </label>
                                                     </div>
                                                      @endforeach
                                                 ...
                                                 <!--               <label class="col-lg-5" style="background:#ddd;padding-top: 5px;">Select-->
                                                 <!--            <select name="time" class="form-control selectFrom">-->
                                                 <!--               @foreach($pm->firstShifts as $firstshift)-->
                                                 <!--               <option value="{{ $firstshift->time_from }}">-->
                                                 <!--                   {{ date('g:i A' ,strtotime($firstshift->time_from)) }} - {{ date('g:i A' ,strtotime($firstshift->time_to)) }}-->
                                                 <!--                   </option>-->
                                            ...
                                            <div class="text-center font20 pad10 mt10" style="background: #4483f7;color: white;">
                                             ...
                                             <div class="container" style="margin-top: 20px;">
                                                 <div class="row preferBdr" style="padding:6px ">
                                                     <b>Shastri Nagar, Delhi - 110096</b><input type="radio" style="float:right " name="optradio">
                                                        
                                                 </div>
                                             </div>
                                             <div class="container" style="margin-top: 20px;">
                                                 <div class="row preferBdr">
                                                     <h4 style="text-align:center"><b>Preference 1</b></h4>
                                                 <div class="col-lg-12">
                                                     <div class="col-lg-4">
                                                     <div class="card" style="border:1px solid gray">
                                                     ...
                                                     <div class="col-lg-8">
                                                        <div class="card" style="border:1px solid gray">
                                                            ...
                                                            <div class="card-body" style="padding:5px">
                                                                 {{ Form::time('time', null, ['class' => 'form-control', 'required' => '']) }}
                                                                <!--<label class="pulll-left" style="background:#ddd;padding-top: 5px;">Select</label>-->
                                             ...
                                             <div class="container" style="margin-top: 20px;">
                                                 <div class="row preferBdr">
                                                     <h4 style="text-align:center"><b>Preference 2</b></h4>
                                                 <div class="col-lg-12">
                                                     <div class="col-lg-4">
                                                     <div class="card" style="border:1px solid gray">
                                                        <div class="card-header dateHeader"><b>Date</b></div>
                                             ...
                                             <div class="container" style="margin-top: 20px;">
                                                 <div class="row preferBdr">
                                                     <h4 style="text-align:center"><b>Preference 3</b></h4>
                                                 <div class="col-lg-12">
                                                     <div class="col-lg-4">
                                                     <div class="card" style="border:1px solid gray">
                                                        <div class="card-header dateHeader"><b>Date</b></div>
                                             ...
                                             {{ Form::hidden('total_pay', $pm->consultation_payout) }}
                ...
                <div class="row ">
                  ...
                  <div  class="col-md-4 mt10">
                   ...
                   <div  class="col-md-4" style="border-left:1px solid #8a7f7f;">
                    <img src="{{ asset('website/images/like.png') }}" /> <strong class="font20">1819</strong><br>
                    <p class="font20">Out of 1830</p>
                  </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 bdrlft">
                            <div class="text26  w500">
                                <p>Asked by : Asha Negi</p>
                            </div>
                        </div>
                        <div class="col-md-4 bdrlft">
                            <div class="text26  w500">
                                <img src="{{asset('website/images/time.png')}}" class="pull-left pdr15" /><p> 25th June 2017</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="text26  w500">
                                <img src="{{asset('website/images/location.png')}}" class="pull-left pdr15" />  <p>Mumbai</p>
                            </div>
                        </div>

                    </div>
                    <div class="q mt20">
                        <a href=""><span>Q. Are sore thighs normal during pregnancy ?</span></a>
                    </div>
                    <div class="a mt10">
                        <span>Is it typical for women to have sort thighs when they are pregnant ? I am 26 and pregnant with my first child, so I don't really know what to expect, but my thighs are extremely tender when I stand or walk. What should I do?</span>
                    </div>
                    <div class="row mt30">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <div class="text20 text-center w500 bdrlft">
                                <b><i class="fa fa-thumbs-up" style="color:#3c8dbc" aria-hidden="true"></i>234</b>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="text20 text-center w500 bdrlft">
                                <b><i class="fa fa-thumbs-down" style="color:#dd4b39" aria-hidden="true"></i>34</b>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="text20 text-center w500 ">
                                <b><i class="fa fa-eye" style="color:#337ab7" aria-hidden="true"></i>12545</b>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal-body">
 <div class="form-group">
   ...
   <select name="availability_id" class="form-control">
     ...
     {{ Form::label('location_id', 'Location *', ['style' => 'margin-top:20px']) }}
            ...
            <div class="card" style="border:1px solid gray">
             ...
             <div class="col-lg-8">
                <div class="card" style="border:1px solid gray">
                    <div class="card-header dateHeader"><b>Time</b></div>
                    <div class="form-control" style="height:50px">
                    <label class="col-lg-10" style="background:#ddd;padding-top: 5px;">Select
                    <select name="time" class="form-control selectFrom">
                        @foreach($pc->firstShifts as $firstshift)
                        <option value="{{ $firstshift->time_from }}">
                            {{ date('g:i A' ,strtotime($firstshift->time_from)) }} - {{ date('g:i A' ,strtotime($firstshift->time_to)) }}
 ...
 <div class="text-center pad10 mt10" style="background: #4483f7;color: white;">
        <p>CHOOSE ANY 3 PREFER DATE ACCORDING TO YOUR CONVENIENCE FOR THE APPOINTMENT</p>
 </div>
...
<button class="btn btn-default btn-sm" data-dismiss="modal" onclick="window.location = '{{route('advisers-category.show', $author->id)}}'">Cancel</button>
</div>
{!! Form::close() !!}
</div>
</div>
