    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
      <div class="menu_section">
        ...
        <ul class="nav side-menu">
          ...
          <li><a href="{{ route('basicDetails.index') }}"><i class="fa fa-user"></i> Profile</a></li>
          ...
          <li><a href="{{ route('categories.index') }}"><i class="fa fa-calendar-check-o"></i> Categories</a></li>
          <li><a><i class="fa fa-calendar-times-o"></i> Sub-categories <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
              <li><a href="{{ route('sub-categories.index') }}">All Sub-categories</a></li>
              <li><a href="{{ route('sub-categories.create') }}">New Sub-category</a></li>
            </ul>
          </li>
          <li><a href="{{ route('consultations.index') }}"><i class="fa fa-calendar-check-o"></i> Consultation Mode</a></li>
