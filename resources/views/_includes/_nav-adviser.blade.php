    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
      <div class="menu_section">
        ...
        <ul class="nav side-menu">
          ...
          <li><a><i class="fa fa-calendar-check-o"></i> Availability <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
              <li><a href="#">All Doctors</a></li>
              <li><a href="#">Add New</a></li>
            </ul>
          </li>
          <li><a><i class="fa fa-calendar-times-o"></i> Un-availability <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
