...
<section class="content">
  ...
  <div class="container-fluid">
    ...
    <form class="navbar-form navbar-left"  action="{{ route('user.questions.search') }}" method="POST" role="search">
     {{ csrf_field() }}
                            ...
                            <div class="col-lg-12">
                              {!! Form::open(['route' => ['asks.store'], 'method' => 'POST']) !!}
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="category" id="Usercategory">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="sub_category" id="Usersubcategory">
                                      <option value=""></option>
                                    </select>
                                </div>
                                <div class="form-group">
    ...
    @foreach($asks as $ask)
      <div class="col-lg-12">
        <div class="box box-default">
                 ...
                 <div class="box-body">
                   <h3><a href="{{route('user.questions.show', $ask->id)}}" style="color:black">{{$ask->question}}</a></h3>
                 <div>
...
<script>
    $('#Usercategory').on('change', function(e){
     ...
     $.get('http://testserver.adviceli.com/public/newGet?cat_id=' + cat_id, function(data){
       $('#Usersubcategory').empty();
       $.each(data, function(index, subcatObj){
         $('#Usersubcategory').append('<option value="'+subcatObj.id+'">'+subcatObj.name+'</option>')
       });
     });
    });
