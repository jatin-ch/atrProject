            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="chat-info">
                                <h2><span class="label label-success">Welcome to the Adviceli</span></h2>
                                <p><span class="label label-default">Choose one of Adviser from left sidebar to make a conversion.</span></p>
                            </div>
