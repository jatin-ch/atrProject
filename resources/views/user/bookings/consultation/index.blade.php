                      ...
                      <div class="panel-body">
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="modal-body">
                           {!! Form::open(['route' => ['user.bookings.consultation.cancel', $consultation->id], 'method' => 'POST', 'id' => 'cc1'.$consultation->id]) !!}
                        ...
                        <div class="col-md-12">
                          {!! Form::open(['route' => ['user.bookings.consultation.confirm', $consultation->id], 'method' => 'POST', 'id' => 'cmdt'.$consultation->id]) !!}
                          <table class="table">
                            <tbody>
                    ...
                    <div class="panel-heading">
                      ...
                      <div class="panel-body">
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="modal-body">
                          {!! Form::open(['route' => ['user.bookings.reschedule', $consultation->id], 'method' => 'POST', 'id' => 'rs1'.$consultation->id, 'class' => 'form-inline']) !!}
                           <div class="form-group">
                          ...
                          {!! Form::open(['route' => ['user.bookings.consultation.document', $consultation->id], 'method' => 'POST', 'files' => true, 'id' =>'cbd'.$consultation->id]) !!}
                          ...
                          <div class="modal-body">
                           {!! Form::open(['route' => ['user.bookings.consultation.cancel', $consultation->id], 'method' => 'POST', 'id' => 'cc2'.$consultation->id]) !!}
                           <div class="form-group">
                             {{ Form::label('reason', 'Reason to cancel Consultation') }}
                             <select name="reason" class="form-control">
                               <option>Not available on scheduled time.</option>
