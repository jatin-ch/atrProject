                            ...
                            <div class="col-lg-12">
                              {!! Form::open(['route' => ['asks.store'], 'method' => 'POST']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="sub_category" id="subcategory1">
                                      <option value=""></option>
                                    </select>
                                </div>
                                <div class="form-group">
       ...
       $('#category1').on('change', function(e){
         ...
         $.get('http://testserver.adviceli.com/public/newGet?cat_id=' + cat_id, function(data){
           ...
           $.each(data, function(index, subcatObj){
             $('#subcategory1').append('<option value="'+subcatObj.id+'">'+subcatObj.name+'</option>')
           });
         });
       });
     </script>
