               ...
               <div class="col-lg-12">
                   <div class="box box-default">
                       <div class="box-header with-border heading">
                           <div class="col-lg-8">
                               <form action="{{ route('admin.services.search') }}" method="GET" role="search">
                       ...
                       <div class="box-body pd10">
                           ...
                           <div class="col-md-12">
                            @if(isset($query))
                    		<p> The Search results for service <b> {{ $query }} </b> are :</p>
                    		@endif
                			@if(isset($message))
                           ...
                           <div class="col-lg-6">
                               <div class="box box-default" style="border-top-color: #5a8dff!important;">
                                   ...
                                   <div class="box-footer servfooter">
                                       ...
                                       <a class="footercontent" href="{{route('admin.services.edit', $service->id)}}">
                                           <img src=" /images/edit.png" />
                                       </a>

                                       <a href="{{route('admin.services.show', $service->id)}}" class="btn btn-success pull-right">Show</a>
                                   </div>
                               </div>
                           </div>
                          @endforeach
