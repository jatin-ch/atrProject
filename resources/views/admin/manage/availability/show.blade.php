              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="border:none;width:12%">
                     <input type="radio" class="flat" name="time_slot" value="75" required /> 75 min
                  </td>
                  <td style="border:none;width:10%">
                     <input type="radio" class="flat" name="time_slot" value="90" required /> 90 min
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td style="border:none">
                     <input type="radio" class="flat" name="consultation_question" value="40" required /> 40
                  </td>
                  <td style="border:none">
                     <input type="radio" class="flat" name="consultation_question" value="unlimited" required /> unlimited
                  </td>
                </tr>
              
                <tr class="borderTop rows">
                  <td>
                  ...
                  <td  colspan="2">
                    ...
                    @if(isset($user->commission))
                    {{ Form::text('consultation_commision', $user->commission->price, ['class' => 'form-control', 'id' => 'field2', 'readonly'=>'']) }}
                    @else
...
<div class="panel panel-default">
            ...
            @if($availability->consultation_mode == 'chat')
             ...
             <tr>
               ...
               <td style="border:none">
                 {{ Form::label('consultation_commision', 'ADVICELI COMMISION') }}
                    @if(isset($user->commission))
                    {{ Form::text('consultation_commision', $user->commission->price, ['class' => 'form-control', 'id' => 'field21', 'readonly'=>'']) }}
                    @else
  ...
  <div class="panel-body">
    ...
    @if(isset($availability->consultation_commision))
      <p>Consultation Payout : <strike>INR {{ $availability->consultation_fee }} /-</strike> <strong>INR {{ $availability->consultation_payout }} /-</strong></p>
    @else
