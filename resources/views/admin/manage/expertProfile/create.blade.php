...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Expert Details</a></li>
      </ol>
    </section>
...
<div class="col-md-12">
    <div class="panel panel-default">
        <div class="panel-heading">
         <label>   Adviser's Expert Details</label>  
        </div>

        <div class="panel-body">
          {!! Form::open(['route' => ['expertProfile.store'], 'method' => 'POST', 'id' => 'sf123']) !!}
          ...
          <div class="form-group">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                 <label>   EDUCATIONS</label>  <button class="add_field_button1 btn btn-success btn-sm pull-right">Add More Fields</button>
                </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                <label>  WORK EXPERIENCE</label><button class="add_field_button2 btn btn-success btn-sm pull-right">Add More Fields</button>
                </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                 <label>   SPECIALIZATION</label>  <button class="add_field_button3 btn btn-success btn-sm pull-right">Add More Fields</button>
                </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                  <label>  MEMBERSHIP</label>  <button class="add_field_button4 btn btn-success btn-sm pull-right">Add More Fields</button>
                </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                  <label>  AWARDS</label>  <button class="add_field_button5 btn btn-success btn-sm pull-right">Add More Fields</button>
                </div>
            ...
            <button class="btn btn-success pull-right" onclick="document.getElementById(sf123).submit();">Save & Next</button>
