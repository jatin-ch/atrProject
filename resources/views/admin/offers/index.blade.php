                                 ...
                                 <div class="row">
                                  ...
                                  <div class="col-lg-12 basicdetail" style="margin: 0px!important;border: 1px solid #dcdce6;border-radius: 3px;">
                                    ...
                                    <div class="col-lg-2 text-center" style="border-left: 1px solid; padding: 10px;margin-bottom: 10px">
                                        ...
                                        <a href="{{route('admin.offers.show', $offer->id)}}" class="btn btn-default mt10">View Offer</a>

                                        <a href="{{route('admin.offers.edit', $offer->id)}}" class="btn btn-default mt10">Edit Offer</a>

                                        {{ Form::open(['route' => ['admin.offers.destroy', $offer->id], 'method' => 'DELETE', 'id' => $offer->id]) }}
                                        {{ Form::close() }}
                                        <a onclick="
                                  ...
                                  @endforeach
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="running">
                                           <div class="row">
                            <div class="col-lg-12">
                            <form action="{{ route('admin.offers.filter') }}" method="POST" role="search">
                            {{ csrf_field() }}
                             <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-4">
                                           ...
                                           <!--    </select>-->
                                           <!--</div>-->
                                           <button type="submit" class="btn btn-success mt20">Go!</button>
                                       </div>
                                    </form>
                            </div>
                            @if(isset($message))
