...
class PostController extends Controller
{
    ...
    public function index()
    {
      ...
      return view('user.posts.index')->withCategories($categories);
    }
    ...
    public function create()
    {
       ...
       return view('user.posts.create')->withCategories($categories)->withUsers($users);
    }
    ...
    public function edit($id)
    {
       ...
       if($mainuser == $user) {
         return view('user.posts.edit')->with('post', $post)->withCategories($categories);
       } else {
        Session::flash('warning', 'You are not allowed for this!');
        return redirect()->back();
      }
